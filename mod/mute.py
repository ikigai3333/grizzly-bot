...
class Mute(commands.Cog):
    ...
    async def mute(self, ctx, member: discord.Member=None, *, reason=None):
        ...
        try:
            embed4=discord.Embed(description=f"Hello **{member.name}**, you have been muted in {ctx.guild.name}. Please abide by the rules next time and respect the members. Thank you!\nYou can see all the server rules by clicking on [this link.](https://discord.com/channels/749099324620669030/749099325098950716/830248577481572383)", color=utils.GCOLOR, timestamp=utils.TIMESTAMP)
            embed4.set_author(name=f"{member.name}, you have been muted.", icon_url=member.avatar_url)
